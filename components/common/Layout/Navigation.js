    ...
    <nav className="bg-white">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <a href="https://github.com/sigmie" className="text-gray-400 px-3 py-2 rounded-md text-sm font-medium">Github</a>
              </div>
          </div>
        </div>
      </div>
      ...
      <div className={`sm:hidden ${open ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="https://github.com/sigmie" className="text-gray-400 block px-3 py-2 rounded-md text-base font-medium">Github</a>
        </div>
      </div>
    </nav>
