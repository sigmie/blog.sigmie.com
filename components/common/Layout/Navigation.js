    ...
    <nav className="bg-white">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                <a href="https://app.sigmie.com" target="_blank" className="text-black hover:no-underline hover:text-orange-500 block px-3 py-2 rounded-md text-base text-sm font-semibold">Application</a>
                <a href="https://docs.sigmie.com" target="_blank" className="text-black hover:no-underline hover:text-orange-500 block px-3 py-2 rounded-md text-base text-sm font-semibold">Docs</a>
              </div>
          </div>
        </div>
      </div>
      ...
      <div className={`sm:hidden ${open ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 text-sm">
          <a href="https://app.sigmie.com" target="_blank" className="text-black hover:no-underline hover:text-orange-500 block px-3 py-2 rounded-md text-base text-sm font-semibold">Application</a>
          <a href="https://docs.sigmie.com" target="_blank" className="text-black hover:no-underline hover:text-orange-500 block px-3 py-2 rounded-md text-base text-sm font-semibold">Documentation</a>
        </div>
      </div>
    </nav>
